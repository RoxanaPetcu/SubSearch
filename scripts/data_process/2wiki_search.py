"""
Preprocess 2WikiMultiHopQA into Search-R1 parquet format.
"""
...
if __name__ == "__main__":
	...
	parser.add_argument("--local_dir", default="./data/2wiki_search_rsearch")
	parser.add_argument("--hdfs_dir", default=None)
	parser.add_argument("--template_type", type=str, default="rsearch")
	args = parser.parse_args()

	hf_config_name = "2wikimultihopqa"
	data_source = "2wikimultihopqa"
	dataset = datasets.load_dataset("RUC-NLPIR/FlashRAG_datasets", hf_config_name)
