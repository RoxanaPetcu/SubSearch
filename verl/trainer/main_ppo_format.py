...
class RewardManager():
    ...
    def __init__(self, tokenizer, num_examine, structure_format_score=0., final_format_score=0., retrieval_score=0., format_score=0., decomposition_bonus=0.) -> None:
        ...
        self.decomposition_bonus = decomposition_bonus
    ...
    def __call__(self, data: DataProto):
        ...
        for i in range(len(data)):
            ...
            score = compute_score_fn(solution_str=sequences_str, ground_truth=ground_truth, 
                                     ...
                                     decomposition_bonus=self.decomposition_bonus)
...
def main_task(config):
    ...
    reward_fn = RewardManager(tokenizer=tokenizer, num_examine=0, 
                              ...
                              decomposition_bonus=config.reward_model.get('decomposition_bonus', 0.))
